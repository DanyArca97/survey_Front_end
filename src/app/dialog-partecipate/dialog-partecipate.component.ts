...
@Component({
  selector: 'dialog-partecipate',
  templateUrl: './dialog-partecipate.component.html',
  styleUrls: ['./dialog-partecipate.component.css']
})
export class DialogPartecipateComponent implements OnInit {
  ...
  constructor(@Inject(MAT_DIALOG_DATA) public data: {
    ...
    mail: string,
    id_survey: number
  }, private ras: RestApiService, public dialogRef: MatDialogRef<DialogPartecipateComponent>, private formBuilder :FormBuilder) { }
